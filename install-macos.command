...
find_utmt_cli() {
  ...
  # 4) Download specific release (v0.9.1.2) asset that looks like macOS CLI
  ...
  [[ -n "$DL_URL" ]] || err "Could not find a macOS CLI asset in v0.9.1.2 release. Supply --utmt <path> instead."
